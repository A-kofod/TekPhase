...
## Vector plotting program for quick visualization of electrical systems.
...
The application does not yet support updating or autoupdating, meaning upon a new release, the user will have to download the newest version and replace the older version. 
